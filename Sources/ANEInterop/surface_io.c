...
#include <arm_neon.h>
#define ARGMAX_MAX_NVECS 512  /* supports up to spatial=4096 */
#endif
...
bool ane_interop_io_argmax_batch_fp16_spatial_nolock(
    ...
    if (spatial > 4096 || (spatial % 8) != 0) n_blocks = 1;
...
bool ane_interop_fused_expansion_argmax_fp16(
    ...
    if (spatial > 4096 || (spatial % 8) != 0) return false;
